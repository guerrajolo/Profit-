...
P - value = .0961 -- This is not significant result. It is not possible to reject the null hypothesis (product type has no influence). Hence, probably product type don't have influence. 
...
```{r}
#x4StarReviews x2StarReviews PositiveServiceReview #Recommendproduct ShippingWeight Price
